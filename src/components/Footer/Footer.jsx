...
const Footer = () => {
  ...
  if (isPayment) { 
    // Footer especial para tela de pagamento
    return (
      <footer className="bg-[#15233A] text-white px-6 py-10">
        <div className="max-w-9xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
          ...
          {/* Ícone único de métodos de pagamento - centralizado */}
          <div className="flex flex-col items-center justify-center">
            <img src={Images.IconPayments} alt="Métodos de pagamento" className="h-14 w-auto" />
          </div>
          {/* Newsletter/contato - à direita */}
          <div className="space-y-2 flex flex-col items-end w-full max-w-xs ml-auto">
