...
const CreditCardForm = () => {
  ...
  return (
    <div className="w-full bg-white rounded-xl border border-blue-200 p-6 flex flex-col gap-4">
      <div className="flex flex-col gap-2">
        ...
        <input
          ...
          className="border border-gray-300 rounded px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-400 bg-[#F8F9FB]"
          maxLength={19}
        />
      </div>
      <div className="flex flex-col gap-2">
        ...
        <div className="flex flex-col flex-1 gap-2">
          ...
          <div className="flex gap-2">
            <select
              ...
              className="border border-gray-300 rounded px-2 py-2 text-sm bg-[#F8F9FB] focus:outline-none"
            >
              <option>CPF</option>
              <option>CNPJ</option>
            </select>
            <input
              ...
              className="border border-gray-300 rounded px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-400 bg-[#F8F9FB] flex-1"
            />
          </div>
        </div>
      </div>
